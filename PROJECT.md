...
|-- photography.html          # Photography gallery (masonry grid, 4 albums, lightbox)
...
1. Create `photography/new-album-slug/` with WebP images
2. Create `photography/new-album-slug/thumbs/` with smaller WebP thumbnails
3. In `photography.html`, add to the `albums` array (~line 418):
   ```javascript
   {
     slug: 'new-album-slug',
     title: 'Location Name',
     ...
     date: 'Month Year',
     cover: 'photography/new-album-slug/COVER_IMAGE.webp',
